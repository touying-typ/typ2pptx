...
class ConvertContext:
    ...
    def child(
        ...
        # matrix mode. Matrix-aware converters do not consult translate_x/y or
        # scale_x/y, so starting from the identity matrix would lose the
        # ancestor transform and place the descendant at raw SVG coordinates.
